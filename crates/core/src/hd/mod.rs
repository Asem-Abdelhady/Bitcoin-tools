...
//! | `wordlist.rs` | 4.1 The 2048 English words |
...
//!
//! 4.1 ends at 64 bytes and 4.2 begins at them. Nothing in `xkey.rs` mentions
//! a mnemonic, and nothing in `mnemonic.rs` mentions a key — BIP32 takes any
//! seed between 16 and 64 bytes, and a mnemonic is one way to have produced
//! it. Keeping that seam clean is why [`Xpriv::new_master`] takes a `&[u8]`
//! rather than a `&Mnemonic`, and why a caller who already has a seed from
